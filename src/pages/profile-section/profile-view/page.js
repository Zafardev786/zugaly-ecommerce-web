...
export default function ProfileSection() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 pb-5 sm:hidden">
      {/* Header */}
      ...
      {/* Quick Wallet & Membership Info */}
      <div className="px-4 mt-4 grid grid-cols-2 gap-3">
        <div className="bg-white p-3 rounded-xl shadow hover:shadow-md active:scale-[0.98] transition-all">
      ...
      <div className="p-3 space-y-3 mt-2">
        {menuItems.map((item, i) => (
          <div
            ...
            className="flex items-center justify-between bg-white p-3 rounded-xl shadow-sm hover:shadow-md active:scale-[0.98] transition-all"
          >
        ...
        <button
          ...
          className="w-full mt-4 bg-red-500 hover:bg-red-600 text-white py-2.5 rounded-xl font-medium shadow-md active:scale-[0.98] transition-all"
        >
          Logout
        </button>
      </div>
