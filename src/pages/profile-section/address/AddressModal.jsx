...
import muzaffarpurAreas from "@/components/data/muzaffarpurAreas";
  ...
  return (
    <>
      <section className="bg-gradient-to-br from-green-50 to-white py-2 mb-[60px]">
        <div className="min-h-screen bg-gradient-to-br from-green-50 to-amber-50 py-4  flex items-center justify-center px-4">
